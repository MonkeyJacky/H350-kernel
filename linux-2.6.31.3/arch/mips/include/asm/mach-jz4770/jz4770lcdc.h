...
#define LCD_PCFG_MD             (1 << 31)
#define LCD_PCFG_HP_BST         28

#define LCD_PCFG_2_BIT          8
#define LCD_PCFG_2_MASK         (1 << LCD_PCFG_2_BIT)
#define LCD_PCFG_1_BIT          4
#define LCD_PCFG_1_MASK         (1 << LCD_PCFG_1_BIT)
#define LCD_PCFG_0_BIT          0
#define LCD_PCFG_0_MASK         (1 << LCD_PCFG_0_BIT)
