...
*/
        ...
        {
          .gpio = H350_KEY_UP,
          .active_low = H350_KEY_UP_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_DOWN,
          .active_low = H350_KEY_DOWN_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_LEFT, 
          .active_low = H350_KEY_LEFT_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_RIGHT, 
          .active_low = H350_KEY_RIGHT_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_A, 
          .active_low = H350_KEY_A_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_B, 
          .active_low = H350_KEY_B_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_X, 
          .active_low = H350_KEY_X_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_Y, 
          .active_low = H350_KEY_Y_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_Left, 
          .active_low = H350_KEY_Left_ACTIVELOW,
        ...
        {
          .gpio = H350_KEY_START, 
          .active_low = H350_KEY_START_ACTIVELOW,
        },
        {
          .gpio = H350_KEY_SELECT , 
          .active_low = H350_KEY_SELECT_ACTIVELOW,
        },
};
...
#else
	[5] = {"rootfs",12*1024*1024,90*1024*1024,1}, //12MB - 100MB
	[6] = {"data",102*1024*1024,20*1024*1024,1},//268MB - 100MB
	[7] = {"cache",122*1024*1024,20*1024*1024,1},//768MB - 32MB
	//[8] = {"test_0",262*1024*1024,3596*1024*1024,0},
	[8] = {"test_0",142*1024*1024,0xffffffff},
#endif
};
#endif
...
static struct i2c_board_info pisces_i2c1_devs[] __initdata = {
        ...
        {
                I2C_BOARD_INFO("gsensor_i2c", 0x15), //0x15 
	},

};

static struct i2c_board_info pisces_i2c2_devs[] __initdata = {
...
void __init board_i2c_init(void) {
   	...
   	i2c_register_board_info(2, pisces_i2c2_devs, ARRAY_SIZE(pisces_i2c2_devs));
#if defined(CONFIG_I2C_GPIO)
	platform_device_register(&pyxis_i2c_gpio_device);
        i2c_register_board_info(3, pyxis_gpio_i2c_devs, ARRAY_SIZE(pyxis_gpio_i2c_devs));
...
struct hdmi_it6610_pin_info h350_it6610_pin_info = {
...
struct hdmi_it6610_board_info h350_ite6610_board_info = {
	.pin_info = &h350_it6610_pin_info,
#ifdef CONFIG_HDMI_HOTPLUG_HPD_CONNECT_LOW_ACTIVE
	.hpd_connect_active = 0,
#else
	.hpd_connect_active = 1,
#endif
	.hdmi_board_init = h350_hdmi_board_init,
	.hdmi_power_on = h350_hdmi_power_on,
	.hdmi_power_off = h350_hdmi_power_off,
};

static struct platform_device board_ite6610_device = {
	.name = "ite6610-drv",
	.dev = { .platform_data = &h350_ite6610_board_info },
};
static int __init h350_board_init(void)
{
