...
#define SYSRQ_ALT		10	/* Alternate sysrq button (index in jz_button table) */
	...
	{ .gpio = (H350_KEY_UP    )/*GPE0*/,	.actlow = H350_KEY_UP_ACTIVELOW    ,	.ncode = KEY_UP,	.scode = KEY_VOLUMEUP,		.sysrq = 's'	}, /* D-pad up */
	{ .gpio = (H350_KEY_DOWN  )/*GPE1*/,	.actlow = H350_KEY_DOWN_ACTIVELOW  , 	.ncode = KEY_DOWN,	.scode = KEY_VOLUMEDOWN,	.sysrq = 'u'	}, /* D-pad down */
	{ .gpio = (H350_KEY_LEFT  )/*GPE2*/,	.actlow = H350_KEY_LEFT_ACTIVELOW  ,	.ncode = KEY_LEFT,	.scode = KEY_BRIGHTNESSDOWN,	.sysrq = 'e'	}, /* D-pad left */
	{ .gpio = (H350_KEY_RIGHT )/*GPE3*/,	.actlow = H350_KEY_RIGHT_ACTIVELOW ,	.ncode = KEY_RIGHT,	.scode = KEY_BRIGHTNESSUP,	.sysrq = 'i'	}, /* D-pad right */
	{ .gpio = (H350_KEY_A     )/*GPC31*/,	.actlow = H350_KEY_A_ACTIVELOW     ,	.ncode = KEY_LEFTCTRL,							}, /* A button */
	{ .gpio = (H350_KEY_B     )/*GPE11*/,	.actlow = H350_KEY_B_ACTIVELOW     ,	.ncode = KEY_LEFTALT,							}, /* B button */
	{ .gpio = (H350_KEY_X     )/*GPD16*/,	.actlow = H350_KEY_X_ACTIVELOW     ,	.ncode = KEY_SPACE,							}, /* X button */
	{ .gpio = (H350_KEY_Y     )/*GPD17*/,	.actlow = H350_KEY_Y_ACTIVELOW     ,	.ncode = KEY_LEFTSHIFT,							}, /* Y button */
	{ .gpio = (H350_KEY_Left  )/*GPE7*/,	.actlow = H350_KEY_Left_ACTIVELOW  ,	.ncode = KEY_TAB,	.scode = KEY_EXIT				}, /* Left shoulder button */
	{ .gpio = (H350_KEY_Right )/*GPE10*/,	.actlow = H350_KEY_Right_ACTIVELOW ,	.ncode = KEY_BACKSPACE,							}, /* Right shoulder button */
	{ .gpio = (H350_KEY_START )/*GPD21*/,	.actlow = H350_KEY_START_ACTIVELOW ,	.ncode = KEY_ENTER,							}, /* START button(SYSRQ) */
	{ .gpio = (H350_KEY_SELECT)/*GPE8*/,	.actlow = H350_KEY_SELECT_ACTIVELOW,	.ncode = KEY_ESC,	.scode = KEY_MENU,		.sysrq = 'b'	}, /* SELECT button */
